...
import { MOCK_DISPUTES, MOCK_BOOKINGS, MOCK_USERS, MOCK_THREADS } from '../../../constants';
import type { Dispute, Booking, User, Thread, ChatMessage } from '../../../types';
...
const Disputes: React.FC = () => {
    ...
    const handleResolve = (disputeId: number, winner: 'renter' | 'hubber', reason: string) => {
        ...
        if (bookingIndex > -1) {
            // Logic for resolution: if renter wins, they get deposit back, booking is 'completed'. If hubber wins, they get deposit, booking is also 'completed' but with financial consequences handled by backend. We'll just mark as completed for UI.
